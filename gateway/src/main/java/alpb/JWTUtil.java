...
public class JWTUtil {
    ...
    public String createAccessToken(int userIdx) {
        return create(userIdx, "access-token", accessTokenExpireTime);
    }

    //	AccessToken에 비해 유효기간을 길게 설정.
    public String createRefreshToken(int userIdx) {
        return create(userIdx, "refresh-token", refreshTokenExpireTime);
    }
...
//		jwt 토큰의 구성 : header + payload + signature
    private String create(int userIdx, String subject, long expireTime) {
...
//			Claims 는 Map 구현체 형태
    ...
    public Map<String, Object>  getUserIdx(String authorization) {
