...
<template>
    ...
    >
        <div :class="props.transparent || props.light || props.dark ? 'container' : 'container-fluid px-0'">
            ...
            <button class="btn btn-sm" :class="props.action.color + ' mb-0 ms-auto d-lg-none d-block'" @click="moveLogin">LOGIN</button>
            <button
            ...
            <div class="collapse navbar-collapse w-100 pt-3 pb-2 py-lg-0" id="navigation">
                <ul class="navbar-nav navbar-nav-hover ms-auto">
                    <li class="nav-item dropdown dropdown-hover mx-2 me-3">
                    </li>
                </ul>
                <ul class="navbar-nav d-lg-block d-none">
                    <li class="nav-item">
                        <a class="btn btn-sm mb-0" :class="action.color" @click="moveLogin">LOGIN</a>
                    </li>
                </ul>
            </div>
        </div>
